...
?>
	...
	<div class="col-sm-8 content list">
		<h1 class="page-title"><?php _e( 'Topic:', 'thewpcrowd' );?> <?php echo $wp_query->get_queried_object()->name; ?></h1>
		<?php if( have_posts() ) : ?>
		...
		<?php endwhile; ?>
		<?php else: ?>
			<h2 class="page-title"><?php _e( 'Empty Topic... we will likely be talking about this stuff at some point maybe later.', 'thewpcrowd' );?></h2>
		<?php endif;?>
	</div>
	<div class="col-sm-4">
